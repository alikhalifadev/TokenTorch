...
#[derive(Debug)]
pub struct TokenTorchProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenTorchProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenTorch processing");
    
    let mut processor = TokenTorchProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenTorchProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenTorchProcessor::new(false);
